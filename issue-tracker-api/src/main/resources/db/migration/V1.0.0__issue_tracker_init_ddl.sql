...
create
unique index on project_membership (project_id, employee_id, role_id);

create
index on task_attachment (task_id);

create
index on task (project_id, status_id, assigned_to);

create
index on task_activity (task_id, added_by, started_at, completed_at);